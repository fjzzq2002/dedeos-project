...
def encode_for_similarities(st_model, device, src_ids, rst_logits):
    ...
    # rst_logits is after softmax in this case, sorry for calling it logits
    ...
    tgt_embed = rst_logits@st_model[0].auto_model.embeddings.word_embeddings.weight.to(device)
